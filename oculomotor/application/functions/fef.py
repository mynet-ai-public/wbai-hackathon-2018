...
from .example_baselines_run import common_arg_parser, parse_cmdline_kwargs, train
...
#LOAD_PATH = '../../gym-oculoenv/save_model/ptt.only.a2c.cnn.2400000.pkl'
LOAD_PATH = './wbai-hackathon-2018/model/PointToTargetRetina-v0.skip.a2c.cnn.1000000.pkl'
...
class FEF(object):
    ...
    def __call__(self, inputs):
        ...
        action = self.model.step(retina_image)[0]
        output = self.actions[action][0]
